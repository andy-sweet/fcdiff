"""
Random generators of probabilistic models.
"""
...
class UnsharedRegionModelGenerator(object):
    """
    Genrates random unhshared region models.

    Attributes
    ----------
    rng : :class:`numpy.random.RandomState`
        Random number generator.
    pi_range : :class:`numpy.ndarray`, (2,), 0 <= float <= 1
        Range of probability of an anomalous region.
    eta_range : 0 <= float <= 1
        Range of probability of an anomalous connection btw a typical and anomalous region.
    gamma_range : :class:`numpy.ndarray`, (3,), 0 <= float <= 1
        Range of probability of each template connection type (array sums to 1).
    epsilon_range : 0 <= float <= 1
        Range of probability that a typical connection differs from the template.
    mu_range : :class:`numpy.ndarray`, (3,), -1 <= float <= 1
        Range of mean correlation of each connection type.
    sigma_range : :class:`numpy.ndarray`, (3,), 0 < float
        Range of standard deviation of the correlation of each connection type.
    """
